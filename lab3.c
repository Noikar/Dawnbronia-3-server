...
void lab3_special(int in, int cn) {
    ...
    if (drdata[0] == 3) {
        ...
        case 4:
            ...
            break; // "Im Sueden konnte Ich leider nur einen Zugang zu irgendwelchen Hoehlen finden. Ich werde sie sp�ter erforschen, jetzt will ich erst einmal den Ausgang aus diesem Labyrinth Teil finden. Er muss wohl etwas weiter im Osten liegen."
        case 5:
            log_char(cn, LOG_SYSTEM, 0, "These large crustaceans are too strong, but fortunately very slow.");
            break; // "Diese large crustacean sind viel zu stark, doch zum gl�ck sind sie auch sehr langsam."
        case 6:
