    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (char_dist(cn, co) > 10) {
                if (ppd->guard_talkstep == 20) say(cn, "Do not forget thy password, %s. Next time I will ask thee again.", ch[co].name);
            ...
            case 2:
                ...
                break;
            case 3:
                say(cn, "I shall count up to three, then I will kill thee, %s. So move, or say the password!", ch[co].name);
                didsay = 1;
                ppd->guard_talkstep++;
                break;
            case 4:
            ...
            case 5:
                ...
                break;
            case 6:
                say(cn, "Three! %s, I am coming!", ch[co].name);
                ppd->guard_talkstep = 0;
...
void lab3_prisoner_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            case 3: // say(cn,"I wrote it down, so i will not forget it. Wait a moment and I shall give it to thee, %s.",ch[co].name);
...
void lab3_special(int in, int cn) {
    ...
    if (drdata[0] == 3) {
        switch (drdata[1]) {
        case 1:
            log_char(cn, LOG_SYSTEM, 0, "I have to find a way of holding my breath for longer. Too bad one cannot breathe under water.");
        ...
        case 4:
            ...
            break; // "Im Sueden konnte Ich leider nur einen Zugang zu irgendwelchen Hoehlen finden. Ich werde sie spaeter erforschen, jetzt will ich erst einmal den Ausgang aus diesem Labyrinth Teil finden. Er muss wohl etwas weiter im Osten liegen."
        case 5:
            log_char(cn, LOG_SYSTEM, 0, "These large crustaceans are too strong, but fortunately very slow.");
            break; // "Diese large crustacean sind viel zu stark, doch zum glueck sind sie auch sehr langsam."
        case 6:
