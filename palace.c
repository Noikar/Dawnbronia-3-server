        ...
        if (msg->type == NT_CHAR) {
            ...
            if ((ch[co].flags & CF_PLAYER) && char_see_char(cn, co) && (ppd = set_data(co, DRD_ISLENA_PPD, sizeof(struct islena_ppd)))) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    say(cn, "It was never my wish to continue the war of the last eon. So why do we not set the enmity aside? I will forgive thee all the trouble thou hast caused me.");
                    ppd->islena_state++;
                    didsay = 1;
                    break;
                case 3:
